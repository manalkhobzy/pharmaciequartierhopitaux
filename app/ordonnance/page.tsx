...
export const metadata: Metadata = {
  ...
  description:
    "Envoyez votre ordonnance par WhatsApp, nous la préparons à l'avance. Retrait à la pharmacie muni de l'ordonnance originale — pas de livraison. Pharmacie & Para Quartier des Hôpitaux, Casablanca.",
  alternates: {
...
const ETAPES = [
  ...
  },
  {
    ...
    description:
      `Envoyez la photo de votre ordonnance au ${PHARMACIE.whatsappDisplay}. Vous pouvez également préciser si vous souhaitez un générique ou le princeps, et ajouter un commentaire.`,
    bg: '#E3F2FD',
    ...
    <div className="bg-white">
      ...
      <section className="max-w-3xl mx-auto px-6 pb-8">
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 px-8 py-12 text-center">
          <a
            href={`https://wa.me/${PHARMACIE.whatsapp}?text=Bonjour,%20je%20souhaite%20envoyer%20mon%20ordonnance`}
            target="_blank"
        ...
        <div className="flex justify-center gap-4 mt-4">
          <a
            href={`https://wa.me/${PHARMACIE.whatsapp}?text=Bonjour,%20je%20souhaite%20renouveler%20mon%20ordonnance`}
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href={`https://wa.me/${PHARMACIE.whatsapp}?text=Bonjour,%20j'ai%20un%20commentaire%20concernant%20mon%20ordonnance%20:`}
            target="_blank"
            rel="noopener noreferrer"
            className="border border-gray-400 text-gray-600 text-sm font-medium px-6 py-2 rounded-full hover:border-navy hover:text-navy transition-colors"
          >
        ...
        <p className="text-center text-gray-400 text-xs mt-2">
          ...
          <a href={`https://wa.me/${PHARMACIE.whatsapp}`} className="text-navy hover:underline font-medium">
